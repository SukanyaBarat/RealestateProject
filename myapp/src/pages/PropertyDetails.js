...
const PropertyDetails = () => {
  ...
  <div className='container mx-auto min-h-[800px] mb-14'>
    ...
    <div className='flex flex-col items-start gap-8 lg:flex-row '>
      ...
      <div className='flex-1 bg-violet-50 w-full mb-8 border border-gray-300 rounded-lg px-6 py-8'>
        ...
        <form className='flex flex-col gap-y-4'>
          ...
          <textarea className=' border border-gray-300 focus:border-violet-700 outline-none resize-none rounded w-full p-4 h-36 text-sm text-gray-400'placeholder='Message'defaultValue='Hello,I am Interested'></textarea>
          <div className='flex gap-2'>
            <button className=' border  border-violet-700  text-violet-700 hover:bg-violet-800  hover:text-white rounded p-4 text-sm w-full transition'>Send message</button>
            <button className=' border  border-violet-700  text-violet-700 hover:bg-violet-800  hover:text-white rounded p-4 text-sm w-full transition'>Call</button>
          </div>
        </form>
      </div>
    </div>
